...
const Addtocart = () => {
 ...
 const decreaseQuantity=async(id)=>{
    const updatedcart=cart.map((item)=>
        item.id===id?{...item,quantity:Math.max(1, item.quantity-1)}
        : item
    );
    await axios.patch(`http://localhost:3000/users/${uId}`,{cart:updatedcart});
    setCart(updatedcart);
                                            ...
                                            <tr key={item.id}>
                                                <td className="py-4">
                                                    <div className="flex items-center">
                                                        <img className="h-16 w-16 mr-4" src={item.imageUrl} alt={item.name} />
                                                ...
                                                <td className="py-4">
                                                    <div className="flex items-center">
                                                        ...
                                                        <h3 className="text-center w-8">{item.quantity}</h3>
