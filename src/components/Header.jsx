    ...
    <header className="header sticky top-0 w-full bg-red-300 shadow-md flex items-center justify-between px-8 py-2 ">
      ...
      <div className="nav font-semibold text-lg">
        <ul className="flex items-center">
          <li className="p-4 border-b-2 border-white border-opacity-0 hover:border-opacity-100 hover:text-white duration-200 cursor-pointer active font-serif ">
          ...
          <li className="p-4 border-b-2 border-white border-opacity-0 hover:border-opacity-100 hover:text-white duration-200 cursor-pointer font-serif">
