  ...
  return (
    <div className="flex flex-wrap gap-6 justify-center">
      ...
      <div className="text-center p-10 w-full bg-red-300">
        <h1 className="font-mono text-4xl mb-4 text-white  p-4 border-b-2 border-white border-opacity-0 hover:border-opacity-100 hover:text-white duration-200 cursor-pointer active ">
          NEW ARRIVALS
        </h1>
      </div>
